...
from SanskariRobot import NO_LOAD
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 6 : 6 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="Iron_Men_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="Iron_Men_back")]]
...
def send_to_list(
    ...
    if html and markdown:
        raise Exception("ᴄᴀɴ ᴏɴʟʏ ꜱᴇɴᴅ ᴡɪᴛʜ ᴇɪᴛʜᴇʀ ᴍᴀʀᴋᴅᴏᴡɴ ᴏʀ ʜᴛᴍʟ!")
