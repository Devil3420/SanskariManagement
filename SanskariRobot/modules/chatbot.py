...
import html
import requests
import SanskariRobot.modules.sql.chatbot_sql as sql
...
from SanskariRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SanskariRobot import dispatcher, updater, SUPPORT_CHAT
from SanskariRobot.modules.log_channel import gloggable
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Iron_Men Enabled Chats</b>\n"
    for chat in chats:
        try:
