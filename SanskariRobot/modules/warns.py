...
import telegram
from SanskariRobot import TIGERS, WOLVES, dispatcher
...
from SanskariRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from SanskariRobot.modules.helper_funcs.string_handling import split_quotes
from SanskariRobot.modules.log_channel import loggable
from SanskariRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Iron_Men's sticker
        keyboard = None
        log_reason = (
