...
from SanskariRobot import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Pʟᴇᴀsᴇ ᴍᴀᴋᴇ sᴜʀᴇ ʏᴏᴜʀ Hᴇʀᴏᴋᴜ API Kᴇʏ, Yᴏᴜʀ Aᴘᴘ ɴᴀᴍᴇ ᴀʀᴇ ᴄᴏɴғɪɢᴜʀᴇᴅ ᴄᴏʀʀᴇᴄᴛʟʏ ɪɴ ᴛʜᴇ ʜᴇʀᴏᴋᴜ"
        )
