...
import SanskariRobot.modules.sql.notes_sql as sql
from SanskariRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SanskariRobot.__main__ import DATA_IMPORT
from SanskariRobot.modules.helper_funcs.chat_status import user_admin
from SanskariRobot.modules.helper_funcs.alternate import typing_action

# from SanskariRobot.modules.rules import get_rules
import SanskariRobot.modules.sql.rules_sql as rulessql

# from SanskariRobot.modules.sql import warns_sql as warnssql
import SanskariRobot.modules.sql.blacklist_sql as blacklistsql
from SanskariRobot.modules.sql import disable_sql as disabledsql

# from SanskariRobot.modules.sql import cust_filters_sql as filtersql
# import SanskariRobot.modules.sql.welcome_sql as welcsql
import SanskariRobot.modules.sql.locks_sql as locksql
from SanskariRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SanskariRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SanskariRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SanskariRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SanskariRobot{}.backup".format(chat_id))  # Cleaning file
